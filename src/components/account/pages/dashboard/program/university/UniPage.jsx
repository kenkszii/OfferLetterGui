// import "./UniPage.css";
import funnelIcon from "../../../assets/Student/icons/funnel-icon.svg";
import downIcon from "../../../assets/Student/icons/black-drop-down.svg";
import cancelIcon from "../../../assets/Student/icons/cancel-icon.svg";
...
const UniPage = () => {
  ...
  return (
    <section className="unipage">
      <div className="box-border flex overflow-x-hidden ml-[19%]">
        <div className="w-[78vw]">
          <div className="fixed flex z-10 bg-[white] h-[120px] items-center w-[78%] justify-between">
